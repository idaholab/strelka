...
scan_pe = fixtures.scanners.pe
data_exe = fixtures.data("test.exe")
data_overlay_zip_exe = fixtures.data("test_overlay_zip.exe")
    ...
    test_event = make_event(
        ...
        scan={
            ...
            "debug": {
                ...
                "age": 1,
                "pdb": rb"C:\Users\tmcguff\source\repos\HelloWorld\HelloWorld\obj\x64\Release\HelloWorld.pdb",
            },
            "file_info": {
                "fixed": {
                    "flags": [],
            ...
            "compile_time": parse_timestamp("2104-07-18T17:22:04Z"),
            "dll_characteristics": [
                "DYNAMIC_BASE",
                "NX_COMPAT",
                "NO_SEH",
...
def test_scan_pe_overlay(
    scan_pe: Scanner,
    data_overlay_zip_exe: File,
) -> None:
    """
    Pass: Sample event matches output of scanner.
    ...
    test_event = make_event(
        files=[
            make_child(
                "8610fd22-4f94-572d-bc48-c64d1412665e",
                sha1="c8984b30e16acf3d88a49c222937f8e0198a7df9",
                mime_type=["application/octet-stream"],
                name=":pe_overlay",
                size=6442,
            ),
        ],
        flags={"pe:no_certs_found", "pe:overlay"},
        scan={
            "total": {
                "libraries": 0,
                "resources": 2,
