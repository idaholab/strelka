...
from .common.pygments import PygmentsScanner


class ScanBatch(PygmentsScanner):
    """
    ...
    def get_lexer(self) -> lexers.Lexer:
        return lexers.get_lexer_by_name("batch")
